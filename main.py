...
class Game:
    def __init__(self):
        ...
        pg.key.set_repeat(500, 100) # To do press and hold type of movement
        self.load_data()
    ...
    def load_data(self):
        ...
        self.dim_screen.fill((0,0,0,180)) # Fill screen black but semi transparent
        ...
        for effect in EFFECTS_SOUNDS:
            self.effects_sounds[effect] = pg.mixer.Sound(path.join(snd_folder, EFFECTS_SOUNDS[effect]))
